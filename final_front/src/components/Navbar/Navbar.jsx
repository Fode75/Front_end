    ...
    <header className={styles.header}>
      <nav className={styles.nav}>
        ...
        <ul className={styles.links}>
          ...
          <li>
            <NavLink to="/bons-plans" className={({ isActive }) => isActive ? `${styles.link} ${styles.active}` : styles.link}>
              Bons plans
              {savedDeals.length > 0 && <span className={styles.badge}>{savedDeals.length}</span>}
            </NavLink>
          </li>
          <li>
            <NavLink to="/recherches" className={({ isActive }) => isActive ? `${styles.link} ${styles.active}` : styles.link}>
              Recherches
            </NavLink>
          </li>
          <li>
            <NavLink to="/parametres" className={({ isActive }) => isActive ? `${styles.link} ${styles.active}` : styles.link}>
              Paramètres
            </NavLink>
          </li>
        </ul>
